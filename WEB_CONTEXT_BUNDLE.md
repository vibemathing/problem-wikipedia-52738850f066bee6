...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-52738850f066bee6",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-52738850f066bee6",
    ...
    "statement": {
      "language": "en",
      "text": "Closed curve problem: find (explicit) necessary and sufficient conditions that determine when, given two periodic functions with the same period, the integral curve is closed.",
      "version": 1
    },
    "title": "Closed curve problem",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "7c4703f7305852feccc4bace967a6346730525e6cf8e2a577cba1272f760ef5f"
}
```
